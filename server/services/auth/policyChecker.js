const policies = require("../../secrets/policy.json");
...
class PolicyCheker {
  checkPermission(role, resource, action) {
    ...
    let policies = PolicyCollection[role];
  ...
  _checkResource(resource, policy) {
